    ...
    <div>
      <div className="BigDiv">
        <div className="BigDiv_left">
          ...
          <span>Pay in 4</span>
          <span>The shopping app</span>
          <span>Help</span>
        </div>
        <div className="BigDiv_right">
          <button className="nohover">Login</button>
          <button className="hover">Get the app</button>
        </div>
      </div>
      <h1 className="differ heading">All deals and coupons.</h1>
      <p className="differ grey">
        The best online deals and coupons, including Klarna exclusives, updated
        daily.
      </p>
      <div className="haedBlue differ">
        Pay in 4 anywhere with the Chrome extension{" "}
        <a href="https://chrome.google.com/webstore/detail/klarna-shop-now-pay-later/hfapbcheiepjppjbnkphkmegjlipojba?hl=en&utm_source=klarnacom&utm_medium=referral&utm_campaign=klarnacom-deals&utm_content=announcement_banner">
          Add To Chrome
        </a>
        <span
          onClick={() => {
            document.querySelector(".haedBlue").remove();
          }}
          className="cross"
        >
          x
